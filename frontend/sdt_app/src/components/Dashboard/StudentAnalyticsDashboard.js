...
const StudentAnalyticsDashboard = () => {
  ...
  return (
    <Layout>
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-indigo-950/30 to-cyan-950/30 opacity-60 pointer-events-none" />
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        ...
        {/* Digital Twin Indicator Section */}
        {effectiveSelectedStudent !== 'all' && (
          <div className="mb-6 transform transition-all duration-300 hover:scale-[1.01]">
            <div className="bg-gradient-to-r from-indigo-500 to-cyan-600 p-4 rounded-2xl shadow-lg shadow-indigo-500/30">
            ...
            <div className="p-6 bg-indigo-950/50 backdrop-blur-sm rounded-2xl shadow-lg border border-indigo-800/50 mt-4">
        ...
        {effectiveSelectedStudent !== 'all' && (
          <div className="mb-8 transform transition-all duration-300 hover:scale-[1.01] hover:shadow-2xl">
            <div className="bg-indigo-950/50 backdrop-blur-sm rounded-2xl shadow-lg border border-indigo-800/50 overflow-hidden">
              <div className="bg-gradient-to-br from-teal-500 to-emerald-600 p-4">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-indigo-950/50 backdrop-blur-sm rounded-lg flex items-center justify-center">
                    <svg className="w-5 h-5 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mb-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Activity Chart Card */}
          <div className="group transform transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl">
            <div className="bg-indigo-950/50 backdrop-blur-sm rounded-2xl shadow-lg border border-indigo-800/50 overflow-hidden h-full">
              <div className="bg-gradient-to-br from-teal-500 to-emerald-600 p-4">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-indigo-950/50 backdrop-blur-sm rounded-lg flex items-center justify-center">
                    <svg className="w-5 h-5 text-teal-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
