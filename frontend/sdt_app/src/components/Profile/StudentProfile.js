    ...
    const fetchStudentProfile = async () => {
      try {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_API_URL}/student/${currentStudentId}/profile`,
          {
            headers: {
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
          <div className="relative h-48" style={{ backgroundColor: "#8b57d4" }}>
            <div className="absolute -bottom-20 left-8">
              <div
                className="w-40 h-40 rounded-full border-4 border-white shadow-lg overflow-hidden"
                style={{ backgroundColor: "#6d3db8" }}
              >
          ...
          <div className="pt-24 pb-8 px-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
              ...
              <div className="mt-4 sm:mt-0">
                <span
                  className={`px-6 py-3 rounded-full text-base font-medium ${getRiskColor(
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div
                    ...
                    style={{ backgroundColor: "#8b57d41A" }}
                  >
                    <BookOpen
                      className="w-6 h-6"
                      style={{ color: "#8b57d4" }}
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between py-2 border-b border-gray-200">
                    ...
                    <span className="font-medium text-gray-900">
                      {studentInfo.currentGPA.toFixed(1)}%
                    </span>
                  </div>
                  <div className="flex justify-between py-2">
                  ...
                  <div className="flex justify-between py-2">
                    ...
                    <span
                      className={`font-medium capitalize ${
                        getRiskColor(studentInfo.riskLevel).split(" ")[0]
                      }`}
                    >
                      {studentInfo.riskLevel}
                    </span>
              ...
              <div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div
                    ...
                    style={{ backgroundColor: "#8b57d4", width: "75%" }}
                  ></div>
                </div>
              </div>
              <div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="text-2xl font-bold" style={{ color: "#8b57d4" }}>
                  12
                </p>
